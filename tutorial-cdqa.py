...
df = pd.read_csv('data/bnpp_newsroom_v1.1/bnpp_newsroom-v1.1_jlb.csv', converters={'paragraphs': literal_eval})
...
queries = [
    ...
    'What is the new covid tax deadline?',
    'What is the new coronavirus tax deadline?',
